...
/*******************************************************************************
 ...
 File:         $Id: top10_hourly_unicast_stats.php,v afc11c4d72ad 2016/07/14 09:30:20 thurban $
...
*******************************************************************************/
    ...
    $sql = "
        ...
        WHERE
            a.rrd_name = 'unicast_in'
        AND
            b.rrd_name = 'unicast_out'
        ORDER BY
    ...
    $c->addTitle("Top 10 Average Hourly Unicast", "timesbi.ttf", 14);
    ...
    $layer->addDataSet($data3, 0xff8080, "Unicast In");
    $layer->addDataSet($data4, 0x80ff80, "Unicast Out");
