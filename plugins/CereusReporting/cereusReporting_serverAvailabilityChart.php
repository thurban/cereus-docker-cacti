<?php
    /*******************************************************************************
     *
     * File:         $Id: cereusReporting_serverAvailabilityChart.php,v ea43511c66ce 2018/11/11 17:22:55 thurban $
    ...
    * Copyright:    Copyright 2009-2012 by Urban-Software.de / Thomas Urban
	...
	if ( !isset( $_SERVER[ "argv" ][ 0 ] ) || isset( $_SERVER[ 'REQUEST_METHOD' ] ) || isset( $_SERVER[ 'REMOTE_ADDR' ] ) ) {
		...
		$leafid     = filter_input( INPUT_GET, 'leaf_id', FILTER_SANITIZE_NUMBER_INT );
		$tree_id    = filter_input( INPUT_GET, 'tree_id', FILTER_SANITIZE_NUMBER_INT );
		...
		$startTime  = filter_input( INPUT_GET, 'startTime', FILTER_SANITIZE_NUMBER_INT );
		$endTime    = filter_input( INPUT_GET, 'endTime', FILTER_SANITIZE_NUMBER_INT );
		//$mode = filter_input( INPUT_GET, 'mode', FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_LOW | FILTER_FLAG_ENCODE_HIGH );
		//$data = filter_input( INPUT_GET, 'data', FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_LOW | FILTER_FLAG_ENCODE_HIGH );
...
# Display labela on top of bars using 12pt Arial font
    ...
    function addTreeToChart( $tree_id )
    {
	    ...
	    CereusReporting_logger( 'Adding Tree with id : ['.$tree_id.']', "debug", "availability_server" );
